...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'control = robot_api_control.control_action_server:main',
            'client = robot_api_control.main_client:main',
            'test = robot_api_control.test:main',
            'util_control = robot_api_control.util_control:main',
